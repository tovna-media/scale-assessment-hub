...
const TITLE = "Your 30-day free trial — Fully Resourced";
const DESCRIPTION = "Your first 30 days are free. After that, it's $97/month.";

export const Route = createFileRoute("/30-day-trial")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: "https://app.getfullyresourced.com/30-day-trial" },
      { property: "og:type", content: "product" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESCRIPTION },
    ],
    links: [{ rel: "canonical", href: "https://app.getfullyresourced.com/30-day-trial" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "Fully Resourced 30-Day Free Trial",
          description: DESCRIPTION,
          url: "https://app.getfullyresourced.com/30-day-trial",
          provider: {
            "@id": "#organization",
            "@type": "Organization",
...
const INCLUDED = [
  "Once a month, sit down with Rich Lohman, a leadership coach with two decades of experience, to review your progress, answer your questions, and keep you moving.",
  "Your 3 assessments and gap report. See the gaps costing you the most.",
  "One clear move each week to help you focus on closing one gap at a time.",
  "The Fully Resourced AI Coach, trained on Rich's decades of work, in your pocket any hour.",
  "A dashboard that tracks your growth over time to help you see your progress.",
];
  ...
  const fetchClientSecret = useCallback(async () => {
    ...
    const result = sessionRef.current
      ...
      : await startPublicCheckout({
          data: {
            returnUrl: `${origin}/30-day-trial/success?session_id={CHECKOUT_SESSION_ID}`,
            environment,
          },
        });
      ...
      <div className="mx-auto flex w-full max-w-xl flex-col gap-8">
        ...
        <header className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-md rounded-xl bg-rl-purple/5 px-4 py-3 text-sm font-medium text-rl-purple">
            Each week for your first month, you'll work through the next step built to close a real
            gap holding you back as a leader.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-rl-purple/25 bg-card p-6 shadow-sm">
          ...
          <p className="mt-4 text-center text-xs leading-relaxed text-muted-foreground">
            Cancel anytime before day 30 and you won't be charged. Your account simply moves to the
            free plan and you keep your gap report. If you don't cancel, your membership starts at
            $97/month after the 30 days. By continuing you agree to our{" "}
