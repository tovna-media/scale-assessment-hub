...
const Email = ({ name, signInUrl = 'https://app.getfullyresourced.com' }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your Fully Resourced membership is active — sign in here.</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={body}>
          Your founding membership is active. Use the button below to sign in —
          it logs you straight into the app, where you can set a password any
        ...
        <Text style={body}>
          Your first step: complete the three SCALE assessments to unlock your
...
const footer = { fontSize: '13px', color: '#6b6b83', marginTop: '32px', wordBreak: 'break-all' as const }
