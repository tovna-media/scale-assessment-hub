...
const Email = ({ name, changeType = 'change', appUrl = APP_URL }: Props) => {
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Your Fully Resourced subscription has been {verb}.</Preview>
      <Body style={s.main}>
        <Container style={s.container}>
          ...
          <Text style={s.body}>
            {name ? `${name}, ` : ''}your Fully Resourced subscription has been {verb}.
...
export const template = {
  component: Email,
  subject: 'Your Fully Resourced subscription was updated',
